            ...
            <div className='grid grid-cols-1 md:grid-cols-6'>
              ...
              <div className='text-lg homepage-card col-span-1 md:col-span-4 row-span-1'>
                ...
                <ul className='pl-8 py-4'>
                  ...
                  <li><Paperlink title="MAC-VO: Metric-Aware Covariance for Learning-based Stereo Visual Odometry" link="https://mac-vo.github.io/" /></li>
                  ...
                  <li>
                    ...
                    <ExperienceHead
                      ...
                      items={[
                        ...
                        <Paperlink key={0} title="MAC-VO: Metric-Aware Covariance for Learning-based Stereo Visual Odometry" link="https://mac-vo.github.io/" />,
                        <Paperlink key={1} title="AirIMU: Learning Uncertainty Propagation for Inertial Odometry" link="https://airimu.github.io/" />,
                        <Paperlink key={2} title="PyPose v0.6: The Imperative Programming Interface for Robotics" link="https://arxiv.org/abs/2309.13035" />
                      ]}
                    />
