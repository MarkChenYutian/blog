...
export default function LTIExperience() {
  return (
    <ExperienceHead compact
      ...
      desc={
        <p>
          Working with Professor <UnderlineLink bold href="http://ayesha.lti.cs.cmu.edu/mlsp/people/rsingh/index.html">Rita Singh</UnderlineLink> and <UnderlineLink bold href="https://scholar.google.com/citations?user=IWcGY98AAAAJ&hl=en">Bhiksha Raj</UnderlineLink>, built a LLM-generated content detector called "LLM-Sentinel".
