...
![短路链接越过了中间的两层卷积](https://markdown-img-1304853431.file.myqcloud.com/20220810233946.png)
...
![短路链接越过了中间的两层卷积](https://markdown-img-1304853431.file.myqcloud.com/20220810233958.png)
...
![Building Blocks of ResNet](https://markdown-img-1304853431.file.myqcloud.com/20220810234013.png)
...
![ResNet 在 CIFAR-10数据集上的表现与前馈卷积网络的表现对比](https://markdown-img-1304853431.file.myqcloud.com/20220810234054.png)
...
![Dense Net Illustration](https://markdown-img-1304853431.file.myqcloud.com/20220810234040.jpeg)

因为DenseNet本质上包含了一个前馈神经网络的所有可能链接，所有的前馈神经网络都可以看作是DenseNet的一种特例来处理。这么多的链接也最大化了DenseNet本身进行特征提取和梯度传播的能力。

### 5.2 U-net

[【文章】医学图像分割模型：U-Net](https://markchenyutian.github.io/blog/2020/U-net.html)
